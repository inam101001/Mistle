...
go.Shape.setFigureParameter(
  "IBeamArrow",
  0,
  new FigureParameter("ConnectorHeight", 0.7, 0.51, 0.97)
);
...
go.Shape.setFigureParameter(
  "RoundedPointer",
  0,
  new FigureParameter("RoundedEdge", 0.3, 0, 0.5)
);
...
go.Shape.setFigureParameter(
  "SplitEndArrow2",
  0,
  new FigureParameter("TailThickness", 50)
);
